scoreboard objectives remove pt_NUMBERS
scoreboard objectives add pt_NUMBERS dummy

scoreboard players set -1 pt_NUMBERS -1
scoreboard players set 0 pt_NUMBERS 0
scoreboard players set 1 pt_NUMBERS 1
...
scoreboard players set 59000000 pt_NUMBERS 59000000